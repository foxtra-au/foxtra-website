...
export const metadata: Metadata = {
  title: 'AI Blog | Foxtra AI - Latest AI Automation Insights',
  description: 'Discover the latest AI automation insights and trends. Read expert articles on AI chat agents, voice automation, SEO optimization, and business transformation strategies. Stay ahead with Foxtra AI\'s comprehensive AI knowledge base.',
