...
export default function ElectriciansSolution() {
  ...
  const services = [
    {
      ...
      description: "Emergency electrical service calls and appointment scheduling for urgent electrical repairs",
      color: "from-blue-500/20 to-purple-500/20"
    },
    {
      icon: Globe,
      title: "Website Improvements",
      description: "Professional electrical contractor website showcasing services, certifications, and service areas",
      color: "from-green-500/20 to-teal-500/20"
    },
    {
      icon: Search,
      title: "Local SEO",
      description: "Optimize for searches like 'electrician near me' and 'emergency electrical services'",
      color: "from-orange-500/20 to-red-500/20"
    },
    {
      icon: Mail,
      title: "SMS Marketing",
      description: "Appointment reminders, safety tips, and electrical maintenance notifications",
      color: "from-purple-500/20 to-pink-500/20"
    },
    {
      icon: BarChart3,
      title: "Google Ads",
      description: "Targeted advertising for electrical services and emergency repairs in your area",
      color: "from-yellow-500/20 to-orange-500/20"
    },
    {
      icon: Zap,
      title: "Emergency Dispatch",
      description: "Automated emergency call routing and priority scheduling for urgent electrical issues",
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <p className="text-lg md:text-xl text-white/40 mb-12 leading-relaxed font-light tracking-wide max-w-3xl mx-auto">
                Power up your electrical business with AI solutions designed for emergency services and customer management.
              </p>
            </motion.div>
