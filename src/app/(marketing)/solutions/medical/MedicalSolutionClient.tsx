...
export default function MedicalSolution() {
  ...
  const services = [
    {
      ...
      description: "HIPAA-compliant phone system for appointment scheduling and patient inquiries",
      color: "from-blue-500/20 to-purple-500/20"
    },
    {
      icon: Globe,
      title: "Website Improvements",
      description: "Professional medical website with online appointment booking and patient portal access",
      color: "from-green-500/20 to-teal-500/20"
    },
    {
      icon: Search,
      title: "Medical SEO",
      description: "Healthcare SEO optimization for specialties like 'family doctor near me' and medical services",
      color: "from-orange-500/20 to-red-500/20"
    },
    {
      icon: Mail,
      title: "Patient Communication",
      description: "Automated appointment reminders, health tips, and follow-up care instructions",
      color: "from-purple-500/20 to-pink-500/20"
    },
    {
      icon: BarChart3,
      title: "Google Ads",
      description: "Healthcare advertising campaigns targeting patients searching for medical services",
      color: "from-yellow-500/20 to-orange-500/20"
    },
    {
      icon: Zap,
      title: "Patient Management",
      description: "Automated patient intake, insurance verification, and appointment scheduling workflows",
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <p className="text-lg md:text-xl text-white/40 mb-12 leading-relaxed font-light tracking-wide max-w-3xl mx-auto">
                Enhance your medical practice with HIPAA-compliant AI solutions designed for healthcare professionals.
              </p>
            </motion.div>
