...
export default function AccountantsSolution() {
  ...
  const services = [
    {
      ...
      description: "Automated phone system to book client appointments and answer common accounting queries 24/7",
      color: "from-blue-500/20 to-purple-500/20"
    },
    {
      icon: Globe,
      title: "Website Improvements",
      description: "Modern, professional website design to showcase your accounting services and build client trust",
      color: "from-green-500/20 to-teal-500/20"
    },
    {
      icon: Search,
      title: "SEO Services",
      description: "Local SEO optimization to help clients find your accounting practice when searching online",
      color: "from-orange-500/20 to-red-500/20"
    },
    {
      icon: Mail,
      title: "Email Marketing",
      description: "Automated email campaigns for tax season reminders, financial tips, and client newsletters",
      color: "from-purple-500/20 to-pink-500/20"
    },
    {
      icon: BarChart3,
      title: "Google Ads",
      description: "Targeted advertising campaigns to reach potential clients searching for accounting services",
      color: "from-yellow-500/20 to-orange-500/20"
    },
    {
      icon: Zap,
      title: "Business Automation",
      description: "Automated workflows for client onboarding, document collection, and follow-up processes",
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <p className="text-lg md:text-xl text-white/40 mb-12 leading-relaxed font-light tracking-wide max-w-3xl mx-auto">
                Streamline your accounting practice with AI-powered solutions designed specifically for accounting professionals.
              </p>
            </motion.div>
