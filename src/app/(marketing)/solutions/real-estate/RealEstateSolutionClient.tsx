  ...
  const services = [
    {
      ...
      description: "Property inquiry handling and appointment scheduling for property viewings and consultations",
      color: "from-blue-500/20 to-purple-500/20"
    },
    {
      icon: Globe,
      title: "Website Improvements",
      description: "Professional real estate website with property listings, virtual tours, and agent profiles",
      color: "from-green-500/20 to-teal-500/20"
    },
    {
      icon: Search,
      title: "Real Estate SEO",
      description: "Local SEO for property searches and neighborhood-specific real estate services",
      color: "from-orange-500/20 to-red-500/20"
    },
    {
      icon: Mail,
      title: "Lead Nurturing",
      description: "Automated email campaigns for property updates, market insights, and client follow-ups",
      color: "from-purple-500/20 to-pink-500/20"
    },
    {
      icon: BarChart3,
      title: "Google Ads",
      description: "Targeted advertising for property listings and real estate services in specific areas",
      color: "from-yellow-500/20 to-orange-500/20"
    },
    {
      icon: Zap,
      title: "Lead Management",
      description: "Automated lead capture, qualification, and follow-up workflows for property inquiries",
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <p className="text-lg md:text-xl text-white/40 mb-12 leading-relaxed font-light tracking-wide max-w-3xl mx-auto">
                Close more deals with AI-powered solutions designed specifically for real estate professionals.
              </p>
            </motion.div>
