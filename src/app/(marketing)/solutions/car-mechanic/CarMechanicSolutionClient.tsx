...
export default function CarMechanicSolution() {
  ...
  const services = [
    {
      ...
      description: "Service appointment booking and vehicle diagnostic inquiries with emergency breakdown support",
      color: "from-blue-500/20 to-purple-500/20"
    },
    {
      icon: Globe,
      title: "Website Improvements",
      description: "Auto repair shop website with service menu, appointment booking, and customer reviews",
      color: "from-green-500/20 to-teal-500/20"
    },
    {
      icon: Search,
      title: "Local SEO",
      description: "Optimize for searches like 'auto repair near me' and 'car mechanic' in your service area",
      color: "from-orange-500/20 to-red-500/20"
    },
    {
      icon: Mail,
      title: "Service Reminders",
      description: "Automated maintenance reminders, service updates, and vehicle care tips for customers",
      color: "from-purple-500/20 to-pink-500/20"
    },
    {
      icon: BarChart3,
      title: "Google Ads",
      description: "Targeted advertising for auto repair services and specific vehicle makes and models",
      color: "from-yellow-500/20 to-orange-500/20"
    },
    {
      icon: Zap,
      title: "Service Management",
      description: "Automated service scheduling, parts ordering, and customer communication workflows",
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <p className="text-lg md:text-xl text-white/40 mb-12 leading-relaxed font-light tracking-wide max-w-3xl mx-auto">
                Rev up your auto repair business with AI-powered solutions designed for automotive service professionals.
              </p>
            </motion.div>
