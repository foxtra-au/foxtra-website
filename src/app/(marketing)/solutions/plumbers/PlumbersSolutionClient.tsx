...
export default function PlumbersSolution() {
  ...
  const services = [
    {
      ...
      description: "Emergency call handling and appointment booking system for urgent plumbing repairs",
      color: "from-blue-500/20 to-purple-500/20"
    },
    {
      icon: Globe,
      title: "Website Improvements",
      description: "Professional website showcasing your plumbing services, emergency contact, and service areas",
      color: "from-green-500/20 to-teal-500/20"
    },
    {
      icon: Search,
      title: "Local SEO",
      description: "Optimize for local searches like 'plumber near me' and 'emergency plumbing services'",
      color: "from-orange-500/20 to-red-500/20"
    },
    {
      icon: Mail,
      title: "SMS Marketing",
      description: "Send appointment reminders, service updates, and maintenance tips to customers",
      color: "from-purple-500/20 to-pink-500/20"
    },
    {
      icon: BarChart3,
      title: "Google Ads",
      description: "Targeted ads for emergency plumbing services and routine maintenance in your service area",
      color: "from-yellow-500/20 to-orange-500/20"
    },
    {
      icon: Zap,
      title: "Emergency Booking",
      description: "Automated emergency call routing and priority scheduling for urgent plumbing issues",
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <p className="text-lg md:text-xl text-white/40 mb-12 leading-relaxed font-light tracking-wide max-w-3xl mx-auto">
                Grow your plumbing business with AI-powered solutions designed for emergency services and customer management.
              </p>
            </motion.div>
