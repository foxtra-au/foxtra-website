...
export default function CarWashSolution() {
  ...
  const services = [
    {
      ...
      description: "Automated booking system for car wash appointments and service inquiries",
      color: "from-blue-500/20 to-purple-500/20"
    },
    {
      icon: Globe,
      title: "Website Improvements",
      description: "Modern car wash website with online booking, service packages, and loyalty programs",
      color: "from-green-500/20 to-teal-500/20"
    },
    {
      icon: Search,
      title: "Local SEO",
      description: "Optimize for searches like 'car wash near me' and 'mobile car detailing'",
      color: "from-orange-500/20 to-red-500/20"
    },
    {
      icon: Mail,
      title: "Customer Retention",
      description: "Automated reminders for regular washes, promotions, and loyalty program updates",
      color: "from-purple-500/20 to-pink-500/20"
    },
    {
      icon: BarChart3,
      title: "Google Ads",
      description: "Targeted advertising for car wash services and seasonal promotions",
      color: "from-yellow-500/20 to-orange-500/20"
    },
    {
      icon: Zap,
      title: "Service Automation",
      description: "Automated scheduling, queue management, and customer communication workflows",
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <p className="text-lg md:text-xl text-white/40 mb-12 leading-relaxed font-light tracking-wide max-w-3xl mx-auto">
                Drive more customers to your car wash business with AI-powered solutions for booking and customer management.
              </p>
            </motion.div>
