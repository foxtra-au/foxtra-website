...
export default function PestControlSolution() {
  ...
  const services = [
    {
      ...
      description: "Emergency pest control calls and appointment scheduling for urgent infestations",
      color: "from-blue-500/20 to-purple-500/20"
    },
    {
      icon: Globe,
      title: "Website Improvements",
      description: "Professional pest control website with service areas, treatment options, and emergency contact",
      color: "from-green-500/20 to-teal-500/20"
    },
    {
      icon: Search,
      title: "Local SEO",
      description: "Optimize for searches like 'pest control near me' and 'emergency exterminator'",
      color: "from-orange-500/20 to-red-500/20"
    },
    {
      icon: Mail,
      title: "Preventive Maintenance",
      description: "Automated reminders for regular treatments, seasonal pest alerts, and follow-up schedules",
      color: "from-purple-500/20 to-pink-500/20"
    },
    {
      icon: BarChart3,
      title: "Google Ads",
      description: "Targeted advertising for pest control services and emergency extermination",
      color: "from-yellow-500/20 to-orange-500/20"
    },
    {
      icon: Zap,
      title: "Emergency Response",
      description: "Automated emergency call routing and priority scheduling for urgent pest infestations",
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <p className="text-lg md:text-xl text-white/40 mb-12 leading-relaxed font-light tracking-wide max-w-3xl mx-auto">
                Eliminate customer service gaps with AI-powered solutions designed for pest control businesses.
              </p>
            </motion.div>
