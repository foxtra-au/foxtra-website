...
export default function LawyersSolution() {
  ...
  const services = [
    {
      ...
      description: "Professional phone system for client consultations, case updates, and appointment scheduling",
    ...
    },
    {
      icon: Search,
      title: "SEO Services",
      description: "Legal SEO optimization to rank for practice areas like 'personal injury lawyer' and 'family law'",
      color: "from-orange-500/20 to-red-500/20"
    },
    {
      icon: Mail,
      title: "Email Marketing",
      description: "Legal newsletters, case updates, and client communication automation",
      color: "from-purple-500/20 to-pink-500/20"
    },
    {
      icon: BarChart3,
      title: "Google Ads",
      description: "Targeted advertising for legal services and practice areas in your jurisdiction",
      color: "from-yellow-500/20 to-orange-500/20"
    },
    {
      icon: Zap,
      title: "Case Management",
      description: "Automated client intake, document collection, and case status updates",
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <p className="text-lg md:text-xl text-white/40 mb-12 leading-relaxed font-light tracking-wide max-w-3xl mx-auto">
                Enhance your law practice with AI-powered solutions designed specifically for legal professionals.
              </p>
            </motion.div>
