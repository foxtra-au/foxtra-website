...
import { Settings, FileCheck, Zap, TrendingUp } from 'lucide-react'

const tiles = [
  {
    icon: Settings,
    title: 'Process Design',
    description: 'Design efficient workflows and operations',
  },
  {
    icon: FileCheck,
    title: 'Process Documentation',
    description: 'Document and standardize procedures',
  },
  {
    icon: Zap,
    title: 'Process Optimization',
    description: 'Streamline and improve existing processes',
  },
  {
    icon: TrendingUp,
    title: 'Performance Metrics',
    description: 'Track and measure process effectiveness',
  },
]
