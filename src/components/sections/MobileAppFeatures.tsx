...
import { Smartphone, Globe, Palette, Upload } from "lucide-react";
...
export function MobileAppFeatures({ 
  ...
  // Map features to appropriate mobile app development related icons
  const getFeatureIcon = (feature: string, index: number) => {
    const iconMap = [Smartphone, Globe, Palette, Upload];
    const IconComponent = iconMap[index] || Smartphone;
