          ...
          <div className="grid md:grid-cols-4 gap-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Salesforce, HubSpot, Pipedrive</CardDescription>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Slack, Teams, Discord</CardDescription>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Stripe, PayPal, Square</CardDescription>
              </CardHeader>
            </Card>
          </div>
        </Container>
