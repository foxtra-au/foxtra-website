...
import { Search, PenLine, Boxes, Gauge } from 'lucide-react';
...
const steps = [
  {
    title: 'Assess',
    description: 'Understanding existing infrastructure and scalability needs.',
    Icon: Search,
  },
  {
    title: 'Design',
    description: 'Defining target architecture and platform standards.',
    Icon: PenLine,
  },
  {
    title: 'Build',
    description: 'Implementing infrastructure, automation and deployment frameworks.',
    Icon: Boxes,
  },
  {
    title: 'Optimise',
    description: 'Monitoring, tuning and continuously improving platform performance.',
    Icon: Gauge,
  },
];
...
export function CloudPlatformProcess() {
  return (
    <section
      id="platform-approach"
      className="relative w-full py-12 md:py-16"
      aria-labelledby="cp-process-heading"
    >
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        ...
        >
          <div className="mb-10 text-left">
            <h2
              id="cp-process-heading"
              className="mb-4 text-3xl font-bold tracking-tight text-white md:text-4xl"
            >
              Structured Platform Delivery Approach
            </h2>
            <p className="text-lg text-white/60">
              A disciplined path from assessment through optimisation
            </p>
          </div>
