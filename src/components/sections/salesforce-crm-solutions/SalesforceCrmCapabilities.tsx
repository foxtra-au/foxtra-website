...
const capabilities: { title: string; description: string; icon: LucideIcon }[] = [
  {
    ...
    description: 'Defining CRM roadmaps aligned with business growth objectives.',
    icon: Compass,
  },
  {
    title: 'Platform Implementation',
    description: 'Delivering structured Salesforce deployment and configuration.',
    icon: Package,
  },
  {
    title: 'Integration & Data Architecture',
    description: 'Connecting Salesforce with enterprise systems and data platforms.',
    icon: Database,
  },
  {
    title: 'Process Automation',
    description: 'Designing workflows to reduce manual operations and improve efficiency.',
    icon: Zap,
  },
  {
    title: 'Platform Optimisation',
    description: 'Enhancing system performance, adoption and scalability.',
    icon: Gauge,
  },
  {
    title: 'Managed Services',
    description: 'Providing ongoing support and continuous platform improvement.',
    icon: Headphones,
  },
];
