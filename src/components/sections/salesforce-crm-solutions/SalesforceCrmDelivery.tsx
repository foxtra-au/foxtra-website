...
const steps = [
  {
    title: 'Assess',
    description: 'Understanding CRM maturity, processes and transformation goals.',
    Icon: ClipboardList,
  },
  {
    title: 'Design',
    description: 'Defining solution architecture and platform roadmap.',
    Icon: PenLine,
  },
  {
    title: 'Implement',
    description: 'Configuring and integrating Salesforce platforms.',
    Icon: Boxes,
  },
  {
    title: 'Optimise',
    description: 'Driving user adoption and continuous improvement.',
    Icon: Sparkles,
  },
];
...
export function SalesforceCrmDelivery() {
  return (
    <section
      id="salesforce-delivery"
      className="relative w-full py-12 md:py-16"
      aria-labelledby="sf-delivery-heading"
    >
