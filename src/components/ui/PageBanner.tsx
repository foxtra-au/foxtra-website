...
export function PageBanner({ title, description, tagline, badge }: PageBannerProps) {
                    ...
                    >
                        ...
                        >
                            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 text-center hover:bg-white/10 transition-all duration-300">
                                ...
                                <h3 className="text-sm font-medium text-white mb-2 mega-menu-text">Discovery</h3>
                                <p className="text-xs text-white/60 mega-menu-text">Understand your needs and goals</p>
                            </div>
                            ...
                            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 text-center hover:bg-white/10 transition-all duration-300">
                                ...
                                <h3 className="text-sm font-medium text-white mb-2 mega-menu-text">Strategy</h3>
                                <p className="text-xs text-white/60 mega-menu-text">Develop comprehensive plan</p>
                            </div>
                            ...
                            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 text-center hover:bg-white/10 transition-all duration-300">
                                ...
                                <h3 className="text-sm font-medium text-white mb-2 mega-menu-text">Implementation</h3>
                                <p className="text-xs text-white/60 mega-menu-text">Execute with precision</p>
                            </div>
                            ...
                            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 text-center hover:bg-white/10 transition-all duration-300">
                                ...
                                <h3 className="text-sm font-medium text-white mb-2 mega-menu-text">Optimization</h3>
                                <p className="text-xs text-white/60 mega-menu-text">Monitor and improve</p>
                            </div>
                        </AnimatedGroup>
                    </motion.div>
                </div>
