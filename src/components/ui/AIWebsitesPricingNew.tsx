...
export default function AIWebsitesPricingNew() {
  return (
    <div className="py-16">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        ...
        <div className="mx-auto max-w-2xl rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 ring-1 ring-white/10 lg:flex lg:max-w-none">
            <div className="p-8 sm:p-10 lg:flex-auto">
              <h3 className="text-3xl font-semibold tracking-tight text-white font-sans">AI Website Package</h3>
            ...
            <div className="-mt-6 p-6 lg:mt-0 lg:w-full lg:max-w-md lg:shrink-0">
              <div className="rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 py-12 text-center ring-1 ring-inset ring-white/10 lg:flex lg:flex-col lg:justify-center lg:py-20 lg:h-full">
                <div className="mx-auto max-w-xs px-8">
                  <p className="text-base font-semibold text-white/70 font-sans">Setup + Monthly</p>
                  <p className="mt-6 flex items-baseline justify-center gap-x-2">
                    <span className="text-5xl font-semibold tracking-tight text-white font-sans">$499</span>
                    <span className="text-sm/6 font-semibold tracking-wide text-white/70 font-sans">USD</span>
                  </p>
                  ...
                  <p className="mt-6 text-xs/5 text-white/60 font-sans">
                    Delivered in 4 hours. Invoices available for easy company reimbursement.
                  </p>
                </div>
              </div>
            </div>
