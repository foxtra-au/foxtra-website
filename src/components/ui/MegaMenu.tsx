                  ...
                  >
                    <div className="flex w-fit shrink-0 space-x-9 overflow-hidden">
                      {navItem.subMenus.map((sub) => (
                        <motion.div layout className="w-full" key={`${navItem.id}-${sub.title}`}>
                            ...
                            {sub.items.map((item) => {
                              ...
                              return (
                                <li key={item.label}>
                                  ...
                                  >
                                    <div className="flex size-9 shrink-0 items-center justify-center rounded-md border border-white/30 text-white transition-colors duration-300 group-hover:text-[#0A0A0A]">
